      ...
      <div className="good-info">
        <div className="row">
          <div className="col-10">
            <h2 className="good-name">{good.name}</h2>
          </div>
          <div className="col-2">
        ...
        <h3 className="good-description">{good.description}</h3>
        <div
          className="btn-wrapper"
          style={{ display: selected ? 'none' : 'flex' }}
          onClick={handleOrderBtn}
        >
          <button className="good-btn">Order Now</button>
        </div>
        <div
          className="select-quantity-btns btn-wrapper"
